...
export const ranks = [
  { name: "Nybegynner", minXP: 0, maxXP: 50, perks: "Kan utføre kriminalitet" },
  {
    name: "Pøbel",
    minXP: 50,
    maxXP: 150,
  ...
  { name: "Torpedo", minXP: 1000, maxXP: 2500, perks: "Kan angripe spillere" },
  { name: "Leiemorder", minXP: 2500, maxXP: 5000, perks: "Kan drepe spillere" },
  {
    name: "Løytnant",
    minXP: 5000,
    maxXP: 10000,
  ...
  { name: "Gudfar", minXP: 20000, maxXP: 40000 },
  { name: "Don", minXP: 40000, maxXP: Infinity },
];
